...
vent_x,vent_y =  676858.0,3534024.0
map_xlim = [vent_x-10000, vent_x+50000]
map_ylim = [vent_y-50000,vent_y+10000]
grid_step = 250

#map_xlim = [vent_x-1000000, vent_x+5000000]
#map_ylim = [vent_y-5000000,vent_y+1000000]
#grid_step = 75000


obs_file = os.path.join('background','points.dat')
